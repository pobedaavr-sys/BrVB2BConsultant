    ...
    <div className="font-sans selection:bg-brand-blue selection:text-white bg-brand-gray">
      ...
      <Section id="services">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card 
            icon={Gamepad2}
            title="Бизнес-игры и стратегические сессии" 
      ...
      <Section className="bg-slate-50/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            ...
            { 
              t: "Практика разборов", 
              d: "Большой опыт работы с запросами бизнеса из разных сфер и на разных стадиях роста.",
              f: "1600+ стратегических и диагностических разборов с собственниками."
            },
            { 
              t: "Бизнес-игры и стратегические сессии", 
      ...
      <Section id="process" className="bg-white border-y border-slate-100">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            { n: "01", t: "Диагностика", d: "Выявление узких мест, причин снижения эффективности и точек роста" },
            { n: "02", t: "Карта узких мест", d: "Проектирование логики изменений." },
            { n: "03", t: "Пересборка & IT", d: "Внедрение инструментов и AI-решений." },
            { n: "04", t: "Сопровождение", d: "Запуск системы и доведение до результата." }
          ].map((step, i) => (
